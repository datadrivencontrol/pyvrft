...
Td11=signal.TransferFunction([-0.4,0.48],[1,-1.4,0.48],dt=1)
...
Cpid=[[signal.TransferFunction([1, 0, 0],[1, -1, 0],dt=1)],[signal.TransferFunction([1, 0],[1, -1, 0],dt=1)],[signal.TransferFunction([1],[1, -1, 0],dt=1)]] # PID controller structure
# assembling the controller structure
C=[[Cpid]] # in this example, we choosed a decentralized PI controller
