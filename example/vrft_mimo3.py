# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 14:07:32 2019

@authors: Diego Eckhard and Emerson Boeira

Testing the inversion algorithm - in this example it is imposible to calculate the inverse of Td
"""
...
# in this example we choosed more columns than lines on Td(z) to verify the inversion algorithm tests
...
Td=[[Td11,Td12,Td13],[Td21,Td22,Td23]]
...
C = [[Cpi,Cpi],[Cpi,Cpi]] # in this example, we choosed a full PI controller
